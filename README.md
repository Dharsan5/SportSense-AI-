...
To run **SportSense AI** locally, run this command on your git bash:
...
Then navigate to the project directory and open `index.html` in your browser:
...
├── dashboard.html          # User dashboard with metrics
├── live-session.html       # Live workout session
├── post-session.html       # Post-workout analysis
├── assets/
│   ├── css/               # Stylesheets
│   ├── js/                # JavaScript files
...
This project is **free to use** and does not contain any license. Feel free to use it for educational purposes.
